...
"faq": {
    ...
    "qn_1": "1. What services does your consultancy offer?",
    "ans_1": "We provide a range of services, including IT user support, technical troubleshooting, web development, custom software development, cybersecurity solutions, and digital transformation consultancy.",
    "qn_2": "2. How do I know if I need IT consultancy services?",
    "ans_2": "If you are experiencing frequent technical issues, need to enhance your business’s digital infrastructure, or are looking for expert advice to improve operational efficiency, IT consultancy can provide tailored solutions.",
    "qn_3": "3. What is the process for engaging your services?",
    "ans_3": "The process begins with an initial consultation to assess your needs. We then provide a detailed proposal that outlines our approach, timelines, and deliverables.",
    "qn_4": "4. Are your services industry-specific?",
    "ans_4": "Our team has experience across various industries, allowing us to deliver customized IT solutions that cater to the unique needs of different business sectors.",
    "qn_5": "5. How can your services improve my business performance?",
    "ans_5": "Our IT solutions focus on optimizing workflows, enhancing security, increasing scalability, and implementing innovative tools to streamline operations and improve productivity.",
    "qn_6": "6. What sets SAM-IT UB apart from other consultancy firms?",
    "ans_6": "Our student-driven team combines innovative thinking, practical expertise, and a fresh perspective on problem-solving, ensuring cost-effective, scalable, and secure solutions. ",
    "qn_7":"7. Do you provide ongoing technical support?",
    "ans_7":" Yes, we offer both one-time assistance and ongoing support services to ensure your IT systems operate seamlessly over time.",
    "qn_8":"8. Can you assist with web development projects? ",
    "ans_8":"Absolutely! Our web development services include custom application design, responsive website development, maintenance, and optimization to meet your unique business needs. ",
    "qn_9":"9. How do you ensure data security in your solutions? ",
    "ans_9":" We prioritize security by implementing advanced data encryption, proactive monitoring, vulnerability analysis, and disaster recovery planning in all our solutions.",
    "qn_10":"10. Do you work with individuals as well as businesses?",
    "ans_10":"Yes, we provide services to both individuals and businesses. Whether you’re an entrepreneur, a student, or a company, our tailored solutions are designed for everyone. ",
    "readMore": " Read More...",
  },
...
"product": {
  ...
  "faq": {
    ...
    "pageDescription": "Svar på alle ofte stilte spørsmål.",
    "pageStillConfused": "Fortsatt usikker? ",
    "contactLinkText": "Ikke nøl med å kontakte Oss.",
   
    "qn_1" : "1. Hvilke tjenester tilbyr deres konsulentselskap? ",
    "ans_1": "Vi tilbyr et bredt spekter av tjenester, inkludert IT-brukerstøtte, teknisk feilsøking, webutvikling, skreddersydd programvareutvikling, cybersikkerhetsløsninger og rådgivning om digital transformasjon ",
    "qn_2" : "2. Hvordan vet jeg om jeg trenger IT-rådgivning? ",
    "ans_2": "Hvis du opplever hyppige tekniske problemer, trenger å forbedre den digitale infrastrukturen i bedriften din, eller søker ekspertråd for å effektivisere driften, kan vi tilby skreddersydde løsninger. ",
    "qn_3" : "3. Hvordan fungerer prosessen for å engasjere deres tjenester? ",
    "ans_3": " Prosessen starter med en innledende konsultasjon for å vurdere dine behov. Deretter gir vi et detaljert forslag som beskriver vår tilnærming, tidslinje og leveranser.",
    "qn_4" : "4. Er tjenestene deres bransjespesifikke?",
    "ans_4": "Vårt team har erfaring fra flere bransjer, noe som gjør oss i stand til å levere tilpassede IT-løsninger for ulike sektorer. ",
    "qn_5" : "5. Hvordan kan deres tjenester forbedre min bedrifts ytelse? ",
    "ans_5": " Våre IT-løsninger fokuserer på å optimalisere arbeidsflyt, forbedre sikkerhet, øke skalerbarhet og implementere innovative verktøy for å effektivisere operasjoner og øke produktivitet.",
    "qn_6" : "6. Hva skiller SAM-IT UB fra andre konsulentfirmaer?",
    "ans_6": " Vårt studentdrevne team kombinerer innovativ tenkning, praktisk ekspertise og en moderne tilnærming, noe som sikrer kostnadseffektive, skalerbare og sikre løsninger.",
    "qn_7" : " 7. Tilbyr dere løpende teknisk støtte? ",
    "ans_7": " Ja, vi tilbyr både engangshjelp og løpende støttetjenester for å sikre at dine IT-systemer fungerer problemfritt over tid.",
    "qn_8" : "8.  Kan dere hjelpe med webutviklingsprosjekter?",
    "ans_8": "Absolutt! Våre webutviklingstjenester inkluderer design av skreddersydde applikasjoner, utvikling av responsivt design, vedlikehold og optimalisering for å oppfylle dine behov. ",
    "qn_9" : "9. Hvordan sikrer dere datasikkerhet i løsningene deres? ",
    "ans_9": " Vi prioriterer sikkerhet ved å implementere avansert datakryptering, proaktiv overvåking, sårbarhetsanalyser og planer for gjenoppretting etter katastrofer.",
    "qn_10" : " 10. Jobber dere med enkeltpersoner så vel som bedrifter?",
    "ans_10": " Ja, vi tilbyr tjenester både til enkeltpersoner og bedrifter. Enten du er gründer, student eller en virksomhet, er våre skreddersydde løsninger designet for alle.",
